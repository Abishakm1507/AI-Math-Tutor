  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="bg-hero-pattern relative">
        <div className="max-w-7xl mx-auto px-4 py-16 sm:py-24 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center">
          <div className="text-center lg:text-left lg:w-1/2">
            ...
            <p className="mt-4 text-xl text-gray-600 dark:text-gray-300 max-w-xl mx-auto lg:mx-0">
          ...
          <div className="mt-10 lg:mt-0 lg:w-1/2 flex justify-center relative">
            <div className="w-full max-w-lg aspect-square">
              <div className="w-full h-full relative">
                ...
                <div className="absolute top-1/3 left-1/4 w-12 h-12 bg-white dark:bg-mathmate-700 rounded-lg shadow-lg flex items-center justify-center animate-float" style={{ animationDelay: "0.5s" }}>
                  <span className="text-lg font-bold text-mathmate-400 dark:text-mathmate-300">f(x)</span>
                </div>
                <div className="absolute top-1/4 right-1/4 w-14 h-14 bg-white dark:bg-mathmate-700 rounded-lg shadow-lg flex items-center justify-center animate-float" style={{ animationDelay: "1s" }}>
                  <span className="text-lg font-bold text-mathmate-400 dark:text-mathmate-300">π</span>
                </div>
                <div className="absolute bottom-1/3 right-1/3 w-16 h-16 bg-white dark:bg-mathmate-700 rounded-lg shadow-lg flex items-center justify-center animate-float" style={{ animationDelay: "1.5s" }}>
                  <span className="text-lg font-bold text-mathmate-400 dark:text-mathmate-300">∑</span>
                </div>
                <div className="absolute bottom-1/4 left-1/3 w-10 h-10 bg-white dark:bg-mathmate-700 rounded-lg shadow-lg flex items-center justify-center animate-float" style={{ animationDelay: "2s" }}>
                  <span className="text-lg font-bold text-mathmate-400 dark:text-mathmate-300">√</span>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <FeatureCard 
              title="Mock Test" 
              description="Prepare for exams with AI-generated practice tests based on your syllabus."
              icon={ClipboardCheck}
            />
            <FeatureCard 
            ...
            <FeatureCard 
              title="Math World (VR)" 
              description="Explore mathematical concepts in an immersive virtual reality environment."
              icon={Box}
            />
            <FeatureCard 
              title="PDF Analyzer" 
              description="Upload study materials and get instant explanations and summaries."
              icon={FileText}
            />
            <div className="sm:col-span-2 lg:col-span-1">
              <FeatureCard 
                title="Fun Zone" 
                description="Learn through interactive games and puzzles designed to reinforce concepts."
                icon={Gamepad2}
              />
            </div>
          </div>
      ...
      {/* CTA Section */}
      <section className="py-16 bg-gradient-to-r from-mathmate-300 to-mathmate-400 text-white">
